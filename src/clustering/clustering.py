...
class cluster_module():
    ...
    def cluster(matrix, num_clusters):
        """
    ...
    def topTerms(vectorizer, km, num_clusters):
        """
    ...
    def cluster_pipeline(k):
        ...
        """
        docs = load_documents()  # Load the documents.
        matrix, vectorizer = vectorize(docs)  # Vectorize the documents.
        km = cluster(matrix, k)  # Apply clustering.
        topTerms(vectorizer, km, k)  # Print the top terms for each cluster.
